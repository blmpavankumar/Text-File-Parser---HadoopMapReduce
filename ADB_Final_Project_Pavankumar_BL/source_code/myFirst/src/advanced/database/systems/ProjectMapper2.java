...
public class ProjectMapper2 extends MapReduceBase implements
Mapper<LongWritable, Text, Text, IntWritable> {
	...
	public void map(LongWritable key, Text value, @SuppressWarnings("rawtypes") OutputCollector output,
		...
		System.out.println("Mapper Job For Query 2 Starting...\n");
		String[] fields=null;
		...
		while (tokenizer.hasMoreTokens()) {
			...
			t2 = new Text(fields[3]);
			output.collect(t1, t2);
		}
		System.out.println("Mapper Job For Query 2 Finished\n");
	}
}
